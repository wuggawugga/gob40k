...
async def menu(
    ...
    """
    Red V3's menu util, slightly modified.
    https://github.com/Cog-Creators/Red-DiscordBot/blob/V3/develop/redbot/core/utils/menus.py
    ...
    try:
        ...
        pages = ["The timer ran out and no one did anything. You failed."]
